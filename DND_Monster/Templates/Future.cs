...
{
    // Class based on Valloric's template, edited for the 'future' template.
    public static partial class Monster
    {        
        // Writes out the HTML needed to render the stat block
        public static string FutureStatBlock()        
        {
            output.Clear();
            ...
            // Inline links
            output.Add(@"<link href=""http://fonts.googleapis.com/css?family=Roboto:700"" rel=""stylesheet"" type=""text/css""/>");
            output.Add(@"<link href=""http://fonts.googleapis.com/css?family=Roboto:400,700,400italic,700italic"" rel=""stylesheet"" type=""text/css""/><meta charset=""utf-8""/>");
            ...
            // Body Style
            #region
            output.Add(@"<body style=""background-image: url('" + Help.FutureBackgroundURI() + @"'); background-repeat: repeat-y;"">");
            output.Add(@"<template id=""tapered-rule"">");
            output.Add(@"<style>");
            output.Add(@"svg {");
            output.Add(@"fill: #292850;");
            output.Add(@"stroke: #292850;");
            ...
            output.Add(@"font-family: 'Roboto', sans-serif;");
            output.Add(@"sans-serif;");
            output.Add(@"font-size: 13px;");
            output.Add(@"display: block;");
            output.Add(@"background: #4c4c4c;");
            ...
            output.Add(@"border-bottom: 1px solid #939393;");
            output.Add(@"color: #939393;");
            ...
            if (_Actions.Count > 0)
            {                
                output.Add(@"<h3 style=""border-bottom: 1px solid #939393; color:#939393; font-size: 18px; font-variant: small-caps; font-weight: normal; letter-spacing: 1px; margin: 0;"">Actions</h3>");                
            }            
            ...
            {
                output.Add(@"<h3 style=""border-bottom: 1px solid #939393; color:#939393; font-size: 18px; font-variant: small-caps; font-weight: normal; letter-spacing: 1px; margin: 0;"">Reactions</h3>");
            ...
            {
                output.Add(@"<h3 style=""border-bottom: 1px solid #939393; color:#939393; font-size: 18px; font-variant: small-caps; font-weight: normal; letter-spacing: 1px; margin: 0;"">Legendary Actions</h3>");
